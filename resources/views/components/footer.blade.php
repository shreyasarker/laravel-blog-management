    ...
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-400">Sharing knowledge and insights with the world.</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li><a href="/blog" wire:navigate class="hover:text-white transition">Blog</a></li>
                    <li><a href="/contact" wire:navigate class="hover:text-white transition">Contact</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-gray-400">
                    ...
                    <li><a href="#" class="hover:text-white transition">Productivity</a></li>
