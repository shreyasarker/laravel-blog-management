...
<div>
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-2">Manage your post tags</p>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition">
                ...
                <div class="flex items-center gap-2 pt-3 border-t border-gray-100">
                    <button 
                        ...
                        class="flex-1 text-sm text-indigo-600 hover:text-indigo-900 font-medium">
                        Edit
                    </button>
                    <button 
                        wire:click="delete({{ $tag->id }})" 
                        wire:confirm="Are you sure you want to delete this tag?"
                        class="flex-1 text-sm text-red-600 hover:text-red-900 font-medium">
                        Delete
                    </button>
                </div>
            </div>
        @empty
            <div class="col-span-full">
                <div class="bg-white rounded-lg shadow-md p-12 text-center">
                    ...
                    <button wire:click="create" class="text-indigo-600 hover:text-indigo-700 font-medium">
                        Add Tag
                    </button>
                </div>
            </div>
